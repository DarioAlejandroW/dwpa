...
author: Alex Stanev, alex at stanev dot org  additions by Dario Alejandro, downloads rkg.txt.gz
...
conf = {
    ...
    'cracker': '',
    'coptions': '',
    'hc_ver': '1.1.2'                               # DAW Follows Alex's version 1.0.1 Rev date 3 April 2018
}
...
class HelpCrack(object):
    ...
    def getcracked(self):
        ...
        if not self.download("https://wpa-sec.stanev.org/dict/cracked.txt.gz", "cracked.txt.gz"):
    ...
    def routerkeygen(self, bssid, ssid, getdict):
        ...
        #with open(self.conf['can_file'], 'wb') as candid:
            #try:
        ...
        # add common number endings, rotate left, rotate right, repeat, add spaces, TODO toggle characters like best64 rules
            ...
            suffix3 = ['123', '666', '777', '007', '111', '200', '100', '321', '101', '999', '555', '333', '001', '456', '199',
                       ...
                       '110', '150', '122', '600', '250', '195', '212', '187', '228', '124', '002', '311', '357', '132', '113',
                       '117', '098', '009', '247', '131', '400', '213', '678', '211', '786', '369', '360', '210', '312', '128']
            suffix4 = ['1234', '12345', '123456', '1234567', '12345678', '123456789', '1234567890',
                       '0123', '01234', '012345', '0123456', '01234567', '012345678', '0123456789',
                       'abc', 'abcd', 'abcde', 'abcdef', 'qwer', 'qwert', 'qwerty', 'asd', 'asdf', 'asdfg', 'asdfgh',
                ...
                while (j < length+1):
                    ...
                    while (i <= length-j):
                        ...
                        for suffix in suffix4:
                            ...
                            f.write('{}{}'.format(Substring, suffix) + "\n")
                            f.write('{}{}'.format(SUBSTRING, suffix) + "\n")
                            f.write('{}{}'.format(suffix, SuBsTrInG) + "\n")
                            f.write('{}{}'.format(suffix, substring) + "\n")
                            f.write('{}{}'.format(suffix, Substring) + "\n")
                            f.write('{}{}'.format(suffix, SUBSTRING) + "\n")
                        ...
                        if j >= 6:
                            for k in range(0, 99):
                                ...
                                f.write('{}{:02d}'.format(Substring, k) + "\n")
                                f.write('{}{:02d}'.format(SUBSTRING, k) + "\n")
                                f.write('{:02d}{}'.format(k, SuBsTrInG) + "\n")
                                f.write('{:02d}{}'.format(k, substring) + "\n")
                                f.write('{:02d}{}'.format(k, Substring) + "\n")
                                f.write('{:02d}{}'.format(k, SUBSTRING) + "\n")
                            for suffix in suffix1:
                                f.write('{}{}{}'.format(suffix, SuBsTrInG, suffix) + "\n")
                                f.write('{}{}{}'.format(suffix, substring, suffix) + "\n")
                                f.write('{}{}{}'.format(suffix, Substring, suffix) + "\n")
                                f.write('{}{}{}'.format(suffix, SUBSTRING, suffix) + "\n")
                        if j >= 7:
